        ...
        <div class='goods-item' v-for="(item,i) of rmlist1" :key='i'>
         ...
         <div class="mui-card-content">
          <div class="mui-card-content-inner ">
            ...
            <div class='avatar'>
            <img :src='`http://127.0.0.1:3000/img/${pic}`' id='rge' @click='send'>
            <span id='u' v-html='user' @click='login'></span>
            </div>
            <div class='content1'>
            <div class='n'>
            <span>我的收藏</span></div>
            ...
            <div class='login' id='rg'>
              ...
              <div class='avatar1' id='va'>
        <form action="http://127.0.0.1:3000/loadFile" method='post' enctype='multipart/form-data'>
        <div class='la'>
        <input type="file" name='mypic' id='oi'>
        <!-- <label for="oi" ></label> -->
...
export default {
   ...
   //登录时用户名的获取
     ...
     avatar(){
         ...
         var url='http://127.0.0.1:3000/avatar?uname='+uname;
         this.axios.get(url).then(result=>{
     ...
     logout(){
         if(sessionStorage.getItem('user')){
          sessionStorage.removeItem('user');
           this.user='未登录';
           var rge=document.getElementById('rge');
           console.log(rge)
          rge.src='img/1.png'
           var cc=this.$refs.v;
